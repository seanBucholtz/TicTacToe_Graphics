...
/**
 * NsccWindow is the primary top-level container
 * for NsccLibrary. It presents a window on the screen.
 */
public class NsccWindow extends JFrame {
   
   /**
    * The zero-parameter constructor for NsccWindow.
   ...
   /**
    * The four-parameter constructor for NsccWindow.
    ...
    */
   public NsccWindow(int x, int y, int w, int h) {
      setSize(w, h);
      setLocation(x, y);
      setVisible(true);
...
/**
 * NsccComponent is the basis for the shapes in 
 * NsccLibrary. It is a simple container/component
 * based on the java.awt.Container class.
 */
class NsccComponent extends Container {

   private boolean filled = false;
   
   /**
    * The zero-parameter constructor for NsccComponent.
    ...
    * of white.
    */
   public NsccComponent() {
      this(0, 0, 25, 25);
   }
   
   /**
    * The four-parameter constructor for NsccComponent.
    ...
    */
   public NsccComponent(int x, int y, int w, int h) {
      setBounds(x, y, w, h);
...
/**
 * NsccRectangle is the simplest graphic component 
 * in NsccLibrary. It is described by the coordinates
 * of the upper-left corner (x, y) and its size
 * (width, height).
 * <blockquote><img src="images/rectangle.png" /></blockquote>
 */
class NsccRectangle extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccRectangle.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
    * of white.
    */
   public NsccRectangle() {
      super(0, 0, 25, 25);
   }
   
   /**
    * The four-parameter constructor for NsccRectangle.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccRectangle(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccEllipse is one of the simple graphic
 * components in NsccLibrary. It presents an ellipse
 ...
 */
class NsccEllipse extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccEllipse.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
   ...
   /**
    * The four-parameter constructor for NsccEllipse.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccEllipse(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccDiamond is one of the simple graphic
 * components in NsccLibrary. It presents a rhombus
 * inscribed within a bounding rectangle. The bounds 
 * of the component describe the bounding rectangle.
 ...
 */
class NsccDiamond extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccDiamond.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
   ...
   /**
    * The four-parameter constructor for NsccDiamond.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccDiamond(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccUpTriangle is one of the simple graphic
 * components in NsccLibrary. It presents a triangle
 * inscribed within a bounding rectangle. The bounds 
 * of the component describe the bounding rectangle.
 ...
 */
class NsccUpTriangle extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccUpTriangle.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
    * of white.
    */
   public NsccUpTriangle() {
      super(0, 0, 25, 25);
   }
   
   /**
    * The four-parameter constructor for NsccUpTriangle.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccUpTriangle(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccDownTriangle is one of the simple graphic
 * components in NsccLibrary. It presents a triangle
 * inscribed within a bounding rectangle. The bounds 
 * of the component describe the bounding rectangle.
 ...
 */
class NsccDownTriangle extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccDownTriangle.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
    * of white.
    */
   public NsccDownTriangle() {
      super(0, 0, 25, 25);
   }
   
   /**
    * The four-parameter constructor for NsccDownTriangle.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccDownTriangle(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccLeftTriangle is one of the simple graphic
 * components in NsccLibrary. It presents a triangle
 * inscribed within a bounding rectangle. The bounds 
 * of the component describe the bounding rectangle.
 ...
 */
class NsccLeftTriangle extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccLeftTriangle.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
    * of white.
    */
   public NsccLeftTriangle() {
      super(0, 0, 25, 25);
   }
   
   /**
    * The four-parameter constructor for NsccLeftTriangle.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccLeftTriangle(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccRightTriangle is one of the simple graphic
 * components in NsccLibrary. It presents a triangle
 * inscribed within a bounding rectangle. The bounds 
 * of the component describe the bounding rectangle.
 ...
 */
class NsccRightTriangle extends NsccComponent {
   
   /**
    * The zero-parameter constructor for NsccRightTriangle.
    * This creates a component at location (0, 0) (the
    * upper-left corner of the container), of size 25 x 25.
    * The component is not filled, with a line color
    * (foreground) of black, and a fill color (background)
    * of white.
    */
   public NsccRightTriangle() {
      super(0, 0, 25, 25);
   }
   
   /**
    * The four-parameter constructor for NsccRightTriangle.
    * This creates a component at the given location and
    * of the given size. The component is not filled, with 
    * a line color (foreground) of black, and a fill 
    * color (background) of white.
    ...
    * @param h The height of the component.
    */
   public NsccRightTriangle(int x, int y, int w, int h) {
      super(x, y, w, h);
   }
...
/**
 * NsccLine is one of the simple graphic components 
 * in NsccLibrary. It presents a line. The endpoints
 ...
 */
class NsccLine extends Component {
   
   private boolean nw_se;
   
   /**
    * The four-parameter constructor for NsccLine.
    ...
    */
   public NsccLine(int x1, int y1, int x2, int y2) {
      setEndPoints(x1, y1, x2, y2);
      setForeground(Color.black);
   }
   
   /**
    * Sets the endpoints for the current NsccLine.
    * 
    * @param x1 The x-coordinate for the first endpoint.
    * @param y1 The y-coordinate for the first endpoint.
    * @param x2 The x-coordinate for the first endpoint.
